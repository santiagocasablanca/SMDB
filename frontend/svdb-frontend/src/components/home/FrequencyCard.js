...
`);
  ...
  const filter = (
    <Space.Compact block >
      ...
      <Select require mode="multiple" allowClear maxTagCount='responsive' style={{ width: "350px", fontSize: '11px' }} value={selectedChannels} onChange={handleChannelChange} options={channels}>
